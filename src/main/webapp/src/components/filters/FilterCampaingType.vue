<template>
  <div class="filter-campaing-type">
    <div class="filter-campaing-type__content">
...
import {FilterCampaingTypeSchema} from '@/schema/resource/CampaingType/FilterCampaingTypeSchema'

@Component
export default class FilterCampaingType extends Vue {
  @Prop({type: Object, required: true}) collection!: CampaingTypeCollection

  schema = new FilterCampaingTypeSchema()
...
.filter-campaing-type {
  @apply verti p-4 border-b border-primary;

  .filter-campaing-type__content {
