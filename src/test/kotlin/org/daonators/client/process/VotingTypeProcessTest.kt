...
/**
 * Tests VotingType business logic
 * @author Simpli CLI generator
 */
class VotingTypeProcessTest : ProcessTest() {
    private val id = 1L
    private val model = VotingType()

    private val listFilter = AuthVotingTypeListParam()

    private val subject = VotingTypeProcess(context)
